...
MINS = [1200, 0.1, 0.25, 0.2, 100, 0, 0.001] #, 0.001, 400, 5]
MAXS = [1234567, 50, 30, 10, 300, 4, 0.02] #, 0.003, 600, 10]
...
EvalNum = 5
plotDirectory = "yES_6params_scored6_gen" + str(NGEN) + "_pop50_srange0.01-0.3_"  + str(NEVENTS) + "events_eval" + str(EvalNum) # Where to save the plots
plotDirectory += "/"
...
def main():
    ...
    while g < NGEN: #(bestEff < 99.4) or bestDup > 60 or bestFake > 10)
        g = g + 1
